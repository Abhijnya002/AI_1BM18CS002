...
def Check(sentence):
    ...
    if isClause(sentence):
        ...
        sentenceCNF = CNF_conversion(sentence)
        if not sentenceCNF:
            print("Invalid input")
            return
...
def resolution(arg_one, arg_two):
    resolved = False
...
def Ask(sentence):
    ...
    if isClause(sentence):
        ...
        if not sentenceCNF:
            print("Illegal input")
            return
        neg = CNF_conversion(negation(sentenceCNF))
...
if ans == True:
   print('Knowledgebase entails the query which is proved by resolution')
else:
    print("Knowledgebase doesn't entail the query  (empty set is not formed) after resolution")
...
if ans == True:
   print('Knowledge Base entails the query which is proved by resolution')
else:
    print("Knowledge Base doesn't entail the query after resolution(no empty set resulted)")
